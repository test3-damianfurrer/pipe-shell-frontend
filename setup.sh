...
diff -q sh/_pipedget.src.tmpl sh/_pipedget.src && echo "Remember to Set your backend url in sh/_pipedget.src!"
diff -q sh/_pipedget.src.tmpl sh/_pipedget.src && exit
